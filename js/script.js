$(function () {
  ...
  $(".form").hover(function () {
    if ($(this).hasClass("circle")) $(this).toggleClass("circleAnimClass");
  ...
  $("#btn-empty").hover(function () {
    $(".form").toggleClass("emptyAnimClass");
  });
...
function upToDateColHover(colName) {
  for (let elem of $(colName)) {
    if (!$(elem).hasClass("losange")) $(elem).toggleClass("losageAnimClass");
  }
}
